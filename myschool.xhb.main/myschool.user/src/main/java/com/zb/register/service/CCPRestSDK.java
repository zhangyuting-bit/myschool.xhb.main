 ...
 */
package com.zb.register.service;
...
import com.zb.register.utils.CcopHttpClient;
import com.zb.register.utils.DateUtil;
import com.zb.register.utils.EncryptUtil;
import com.zb.register.utils.LoggerUtil;
...
public class CCPRestSDK {
	...
	public HashMap<String, Object> billRecords(String date, String keywords) {
		...
		try {
			...
			HttpRequestBase httpRequestBase=(HttpRequestBase)getHttpRequestBase(1,BillRecords);
			String requsetbody = "";
